# Generated by Django 4.2.1 on 2023-07-06 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, max_length=40, unique=True, verbose_name='Ссылка на сайт магазина')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='adress', to='backend.order')),
            ],
        ),
    ]
